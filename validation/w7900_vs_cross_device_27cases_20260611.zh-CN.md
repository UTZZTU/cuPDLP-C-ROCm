# W7900 vs 既有跨设备 Netlib reference 20260611

> English: [w7900_vs_cross_device_27cases_20260611.md](w7900_vs_cross_device_27cases_20260611.md)

CSV 来源: [w7900_vs_cross_device_27cases_20260611.csv](w7900_vs_cross_device_27cases_20260611.csv)

对比输入:

- 既有跨设备 reference: [cross_device_full_summary.csv](cross_device_full_summary.csv)
...
> 1.0 表示该 case 上 W7900 更快。
< 1.0 表示该 case 上既有 reference 平台更快。
```

注意：既有 cross-device CSV 是单次 `gpu_time_sec`，W7900 baseline 是三次 repeated run 的 median solve time。因此这是跨设备参考比较，不是同平台 tuning gain。
