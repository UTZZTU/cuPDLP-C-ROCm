...
#define QUARTER_WARP_REDUCE_2(val1, val2) { \
  val1 += __shfl_down_sync(0xFFFFFFFFFFFFFFFFULL, val1, 4); \
  val2 += __shfl_down_sync(0xFFFFFFFFFFFFFFFFULL, val2, 4); \
  val1 += __shfl_down_sync(0xFFFFFFFFFFFFFFFFULL, val1, 2); \
  val2 += __shfl_down_sync(0xFFFFFFFFFFFFFFFFULL, val2, 2); \
  val1 += __shfl_down_sync(0xFFFFFFFFFFFFFFFFULL, val1, 1); \
  val2 += __shfl_down_sync(0xFFFFFFFFFFFFFFFFULL, val2, 1); \
}

#define FULL_WARP_REDUCE_2(val1, val2) { \
  val1 += __shfl_down_sync(0xFFFFFFFFFFFFFFFFULL, val1, 16); \
  val2 += __shfl_down_sync(0xFFFFFFFFFFFFFFFFULL, val2, 16); \
  val1 += __shfl_down_sync(0xFFFFFFFFFFFFFFFFULL, val1, 8); \
  val2 += __shfl_down_sync(0xFFFFFFFFFFFFFFFFULL, val2, 8); \
  val1 += __shfl_down_sync(0xFFFFFFFFFFFFFFFFULL, val1, 4); \
  val2 += __shfl_down_sync(0xFFFFFFFFFFFFFFFFULL, val2, 4); \
  val1 += __shfl_down_sync(0xFFFFFFFFFFFFFFFFULL, val1, 2); \
  val2 += __shfl_down_sync(0xFFFFFFFFFFFFFFFFULL, val2, 2); \
...
#define QUARTER_WARP_REDUCE(val) { \
  val += __shfl_down_sync(0xFFFFFFFFFFFFFFFFULL, val, 4); \
  val += __shfl_down_sync(0xFFFFFFFFFFFFFFFFULL, val, 2); \
  val += __shfl_down_sync(0xFFFFFFFFFFFFFFFFULL, val, 1); \
}

#define HALF_WARP_REDUCE(val) { \
  val += __shfl_down_sync(0xFFFFFFFFFFFFFFFFULL, val, 8); \
  val += __shfl_down_sync(0xFFFFFFFFFFFFFFFFULL, val, 4); \
  val += __shfl_down_sync(0xFFFFFFFFFFFFFFFFULL, val, 2); \
  val += __shfl_down_sync(0xFFFFFFFFFFFFFFFFULL, val, 1); \
}
...
#define FULL_WARP_REDUCE(val) { \
  val += __shfl_down_sync(0xFFFFFFFFFFFFFFFFULL, val, 16); \
  val += __shfl_down_sync(0xFFFFFFFFFFFFFFFFULL, val, 8); \
  val += __shfl_down_sync(0xFFFFFFFFFFFFFFFFULL, val, 4); \
  val += __shfl_down_sync(0xFFFFFFFFFFFFFFFFULL, val, 2); \
  val += __shfl_down_sync(0xFFFFFFFFFFFFFFFFULL, val, 1); \
